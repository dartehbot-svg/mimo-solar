...
|--------|-------|------------|--------|
| Расчётное ядро | `core/` | Python + pyswisseph + FastAPI | Работает, 27 тестов |
...
- Поиск лучшего места (скоринг 68 городов по сферам)
- База толкований (10 планет × 12 домов)
- REST API с 7 эндпоинтами (включая /api/chart-image)
- Генерация PDF-отчётов
- Desktop UI с 4 страницами + визуализация колеса карты
- MAX-бот с кнопками, диалоговым сценарием, колесом карты
- Генерация PNG колеса карты через Pillow

### Что нужно доделать
- Улучшить качество PNG колеса карты (сейчас базовое)
- Расширенная база толкований
- Webhook для MAX-бота (нужен домен с HTTPS)
- Система подписок (заглушка готова)
...
Москва, Санкт-Петербург, Сочи, Казань, Екатеринбург, Новосибирск, Калининград, Дубай, Стамбул, Париж, Лондон, Нью-Йорк, Токио, Бангкок, Бали, Тбилиси, Ереван, Белград, Алматы.
